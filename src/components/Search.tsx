      ...
      {(query().length >= 2 && results().length >= 1) && (
        <div class="mt-12">
          <div class="text-sm uppercase mb-2">
            Se ha encontrado {results().length} resultados con {`'${query()}'`}
          </div>
